...
func newOperatingSystems(rootSDK *Latitudesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OperatingSystems {
...
func (s *OperatingSystems) ListPlans(ctx context.Context, pageSize *int64, pageNumber *int64, statsTotal *string, opts ...operations.Option) (*operations.GetPlansOperatingSystemResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/plans/operating_systems")
	if err != nil {
