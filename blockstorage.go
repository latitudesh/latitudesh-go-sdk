...
func (s *BlockStorage) PostStorageVolumesMap(ctx context.Context, id string, requestBody operations.PostStorageVolumesMapRequestBody, opts ...operations.Option) (*operations.PostStorageVolumesMapResponse, error) {
