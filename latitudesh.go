...
// Generated from OpenAPI doc version 2023-06-01 and generator version 2.681.8
...
func New(opts ...SDKOption) *Latitudesh {
	sdk := &Latitudesh{
		SDKVersion: "1.5.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.5.2 2.681.8 2023-06-01 github.com/latitudesh/latitudesh-go-sdk",
