...
// Generated from OpenAPI doc version 2023-06-01 and generator version 2.708.2
...
func New(opts ...SDKOption) *Latitudesh {
	sdk := &Latitudesh{
		SDKVersion: "1.7.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.7.0 2.708.2 2023-06-01 github.com/latitudesh/latitudesh-go-sdk",
