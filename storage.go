...
func (s *Storage) GetStorageVolumes(ctx context.Context, filterProject *string, opts ...operations.Option) (*operations.GetStorageVolumesResponse, error) {
...
func (s *Storage) PostStorageVolumes(ctx context.Context, request operations.PostStorageVolumesStorageRequestBody, opts ...operations.Option) (*operations.PostStorageVolumesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Storage) GetStorageObjects(ctx context.Context, filterProject *string, opts ...operations.Option) (*operations.GetStorageObjectsResponse, error) {
...
func (s *Storage) PostStorageObjects(ctx context.Context, request operations.PostStorageObjectsRequestBody, opts ...operations.Option) (*operations.PostStorageObjectsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"403", "404", "409", "422", "4XX", "500", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
...
func (s *Storage) GetStorageObject(ctx context.Context, id string, opts ...operations.Option) (*operations.GetStorageObjectResponse, error) {
...
func (s *Storage) DeleteStorageObjects(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteStorageObjectsResponse, error) {
