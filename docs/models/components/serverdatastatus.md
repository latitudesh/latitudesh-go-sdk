...
| Name                               | Value                              |
| ---------------------------------- | ---------------------------------- |
| `ServerDataStatusOn`               | on                                 |
| `ServerDataStatusOff`              | off                                |
| `ServerDataStatusUnknown`          | unknown                            |
| `ServerDataStatusDiskErasing`      | disk_erasing                       |
| `ServerDataStatusDeploying`        | deploying                          |
| `ServerDataStatusFailedDeployment` | failed_deployment                  |
| `ServerDataStatusRescueMode`       | rescue_mode                        |