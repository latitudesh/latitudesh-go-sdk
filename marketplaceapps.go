...
func newMarketplaceApps(rootSDK *Latitudesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MarketplaceApps {
...
func (s *MarketplaceApps) ListMarketplaceApps(ctx context.Context, opts ...operations.Option) (*operations.ListMarketplaceAppsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/marketplace_apps")
	if err != nil {
	...
	res := &operations.ListMarketplaceAppsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.MarketplaceApps
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.MarketplaceApps = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *MarketplaceApps) GetMarketplaceApp(ctx context.Context, id string, opts ...operations.Option) (*operations.GetMarketplaceAppResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/marketplace_apps/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetMarketplaceAppResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.MarketplaceApp
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.MarketplaceApp = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
