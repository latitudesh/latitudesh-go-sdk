...
func newPrefixes(rootSDK *Latitudesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Prefixes {
	return &Prefixes{
		rootSDK:          rootSDK,
...
// GetPrefixes - List networks
// List the customer networks owned by the team
func (s *Prefixes) GetPrefixes(ctx context.Context, filterProject *string, filterSite *string, opts ...operations.Option) (*operations.GetPrefixesResponse, error) {
	request := operations.GetPrefixesRequest{
	...
	opURL, err := url.JoinPath(baseURL, "/prefixes")
	if err != nil {
	...
	res := &operations.GetPrefixesResponse{
...
func (s *Prefixes) CreatePrefix(ctx context.Context, request components.CreatePrefix, opts ...operations.Option) (*operations.CreatePrefixResponse, error) {
	...
	res := &operations.CreatePrefixResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// GetPrefix - Retrieve a network
// Retrieve a customer network
func (s *Prefixes) GetPrefix(ctx context.Context, id string, opts ...operations.Option) (*operations.GetPrefixResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/prefixes/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetPrefixResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// DestroyPrefix - Delete a network
// Delete a customer network. Only allowed while the network has no IPs in use.
func (s *Prefixes) DestroyPrefix(ctx context.Context, id string, opts ...operations.Option) (*operations.DestroyPrefixResponse, error) {
	...
	res := &operations.DestroyPrefixResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
