...
func newVM(rootSDK *Latitudesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *VM {
	return &VM{
		rootSDK:          rootSDK,
...
func (s *VM) List(ctx context.Context, filterGpu *bool, opts ...operations.Option) (*operations.GetVMPlansResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/plans/virtual_machines")
	if err != nil {
	...
	res := &operations.GetVMPlansResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.VirtualMachinePlans
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.VirtualMachinePlans = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
