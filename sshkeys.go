...
func (s *SSHKeys) Update(ctx context.Context, projectID string, sshKeyID string, requestBody operations.PutProjectSSHKeySSHKeysRequestBody, opts ...operations.Option) (*operations.PutProjectSSHKeyResponse, error) {
...
func (s *SSHKeys) Delete(ctx context.Context, projectID string, sshKeyID string, opts ...operations.Option) (*operations.DeleteProjectSSHKeyResponse, error) {
