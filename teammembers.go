...
func newTeamMembers(rootSDK *Latitudesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TeamMembers {
	return &TeamMembers{
		rootSDK:          rootSDK,
...
func (s *TeamMembers) PostTeamMembers(ctx context.Context, request operations.PostTeamMembersTeamMembersRequestBody, opts ...operations.Option) (*operations.PostTeamMembersResponse, error) {
	...
	res := &operations.PostTeamMembersResponse{
...
func (s *TeamMembers) Delete(ctx context.Context, userID string, opts ...operations.Option) (*operations.DestroyTeamMemberResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/team/members/{user_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DestroyTeamMemberResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
