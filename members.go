...
func newMembers(sdkConfig sdkConfiguration) *Members {
	return &Members{
...
func (s *Members) List(ctx context.Context, opts ...operations.Option) (*operations.GetTeamMembersResponse, error) {
