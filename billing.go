...
func newBilling(rootSDK *Latitudesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Billing {
	return &Billing{
		rootSDK:          rootSDK,
...
func (s *Billing) ListUsage(ctx context.Context, filterProject string, filterProducts []string, filterPlan *string, opts ...operations.Option) (*operations.GetBillingUsageResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/billing/usage")
	if err != nil {
	...
	res := &operations.GetBillingUsageResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.BillingUsage
