...
// ListElasticIPBgpSessions - List BGP sessions
// List the BGP sessions announcing an elastic IP
func (s *ElasticIps) ListElasticIPBgpSessions(ctx context.Context, elasticIPID string, opts ...operations.Option) (*operations.ListElasticIPBgpSessionsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/elastic_ips/{elastic_ip_id}/bgp_sessions", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListElasticIPBgpSessionsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.BgpSessions
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// CreateElasticIPBgpSession - Create a BGP session
// Announce an elastic IP from a server over BGP
func (s *ElasticIps) CreateElasticIPBgpSession(ctx context.Context, elasticIPID string, createBgpSession components.CreateBgpSession, opts ...operations.Option) (*operations.CreateElasticIPBgpSessionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateBgpSession", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateElasticIPBgpSessionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// GetElasticIPBgpSession - Retrieve a BGP session
// Retrieve a BGP session announcing an elastic IP
func (s *ElasticIps) GetElasticIPBgpSession(ctx context.Context, elasticIPID string, id string, opts ...operations.Option) (*operations.GetElasticIPBgpSessionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/elastic_ips/{elastic_ip_id}/bgp_sessions/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetElasticIPBgpSessionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// DeleteElasticIPBgpSession - Delete a BGP session
// Stop announcing an elastic IP from a server
func (s *ElasticIps) DeleteElasticIPBgpSession(ctx context.Context, elasticIPID string, id string, force *bool, opts ...operations.Option) (*operations.DeleteElasticIPBgpSessionResponse, error) {
	...
	res := &operations.DeleteElasticIPBgpSessionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
